...
# configs variables
NAME=hot-code-push-client-side # Set the bundle file name
...
# Concat files
cat "$PACKAGES_PATH/autoupdate.js" >> $OUTPUT_PATH/$NAME.bundle.js
cat "$PACKAGES_PATH/reload.js" >> $OUTPUT_PATH/$NAME.bundle.js
cat "$PACKAGES_PATH/hot-code-push.js" >> $OUTPUT_PATH/$NAME.bundle.js
